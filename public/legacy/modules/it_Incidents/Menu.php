...
$module_menu[]=array('index.php?module=it_Incidents', "-------------","");

if(ACLController::checkAccess('it_Incidents', 'list', true)){
...
if(ACLController::checkAccess('it_Claims', 'list', true)){
    $module_menu[]=array('index.php?module=it_Claims&action=index&return_module=it_Claims&return_action=DetailView', $mod_strings['LNK_CLAIM_LIST'],'View', 'it_Claims');
}
if(ACLController::checkAccess('it_Complaiants', 'list', true)){
    $module_menu[]=array('index.php?module=it_Complaiants&action=index&return_module=it_Complaiants&return_action=DetailView', $mod_strings['LNK_COMPLAIANT_LIST'],'View', 'it_Complaiants');
}
