 ...
 */
*}
{sugar_include type="smarty" file="modules/it_Services/tpls/PopupHeader.tpl"}
...
{sugar_include type="smarty" file="modules/it_serviceElectronic/tpls/PopupFooter.tpl"}