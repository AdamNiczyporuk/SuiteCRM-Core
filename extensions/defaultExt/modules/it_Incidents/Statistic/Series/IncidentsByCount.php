 ...
 */
 ...
 namespace App\Extension\defaultExt\modules\it_Incidents\Statistic\Series;
...
class IncidentsByCount extends LegacyHandler implements StatisticsProviderInterface
{
    use StatisticsHandlingTrait;

    public const KEY = 'incidents-by-count';
    ...
    public function getData(array $query): Statistic
    {
        ...
        if (empty($module) || $module !== 'it_Incidents') {
...
// TODO  UNION 
//SELECT it_Claims.name ,count(*) as value FROM it_Claims WHERE deleted = 0  union   SELECT it_Complaiants.name,count(*) as value FROM it_Complaiants WHERE deleted =0  GROUP BY name 
